#
# Copyright (C) 2025 Majaahh, edited by @Pealeap/Harvey
#
...
# SEC Floating Feature configuration file for Galaxy A15 5G (a15x)
...
# Device specific
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_BRAND_NAME=Galaxy A15 5G
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_DEFAULT_FONT_SIZE=3
SEC_FLOATING_FEATURE_SETTINGS_CONFIG_FCC_ID=A3LSMA156M
